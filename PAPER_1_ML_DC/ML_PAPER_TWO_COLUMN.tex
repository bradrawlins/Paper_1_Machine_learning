...
% Address/affiliation
\affiliation[1]{organization={Department of Mechanical Engineering, Applied Thermofluid Process Modelling Research Unit, University of Cape Town},
...
\textit{Inputs} [\textbf{mean} - (\textit{min},\textit{max})]& 100\%  & 80\% & 60\% & High-ash & High-moisture  \\
\midrule
...
\midrule
Mean boiler efficiency [\%]& \textbf{88.2} - (\textit{45},\textit{89}) & \textbf{77.6} & \textbf{75.9}\\
Convective pass inlet flue-gas temp. [$K$]& \textbf{1352} & \textbf{1368} & \textbf{1311}\\
\midrule
\multicolumn{4}{l}{\textit{Radiative heat transfer percentage (Convective pass)} }\\
\midrule
RH2 & \textbf{52.3}& \textbf{56.2} & \textbf{50.3}\\
SH1 & \textbf{46.3}& \textbf{49.8}& \textbf{47.2}\\
RH1 & \textbf{21.3}& \textbf{26.7}& \textbf{18.2}\\
ECO & \textbf{6.7}& \textbf{8.3}& \textbf{5.4}\\
\bottomrule
\end{tabular*}
\end{table*}  
