...
\item 1D process and surrogate model integration.
\end{highlights}
...
Introdue the problem, what is needed
risks uncertainty of operational
benfits
co-simulation - uses not fasts

use of data-drvien models

use of data driven model in process model
